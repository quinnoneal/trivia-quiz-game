    ...
    public static void main(String[] args) throws JsonProcessingException {
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                String category = gameDTO.getClues().get(randNum).getCategory().getTitle();
                String question = gameDTO.getClues().get(randNum).getQuestion();
                String answer = gameDTO.getClues().get(randNum).getAnswer();
